  ...
  $(document).ready(function () {
    ...
    $("#reservaLink").on("click", function () {
      ...
      const requestData = {
        ...
        start_date: $("#start-date-1").val(),
        end_date: $("#end-date-1").val(),
        number_people: datos.quantity,
        number_children: datos.children,
      };
    ...
    if (window.location.href.includes("search.html")) {
      ...
      if (datosJSON) {
        ...
        document.getElementById(
          "start-date-1"
        ).value = `${datos.startDate} Fecha inicio`;
        document.getElementById(
          "end-date-1"
        ).value = `${datos.endDate}  Fecha Final`;
        ...
        $(document).ready(function () {
          ...
          var nuevoSelect = $(
            '<div class="nice-select wide" tabindex="0"></div>'
          );
          ...
          nuevoSelect
            .find(`[data-value="${valorSeleccionado}"]`)
            .addClass("selected"); // Agregamos la clase 'selected' al elemento con el valor seleccionado
